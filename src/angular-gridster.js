			...
			this.enableDragMode = function() {
				...
				setTimeout(function() {
					...
					var mouseDownEvent = new MouseEvent('mousedown', {
						clientX: itemRect.left + 25,
						clientY: itemRect.top + 25
					});
			...
			function($document, $window, GridsterTouch) {
				function GridsterDraggable($el, scope, gridster, item, itemOptions) {
					...
					function mouseDown(e) {
						...
						var q = document.getElementsByClassName('overflow-grid')[0];

						startedScrollTop = q.scrollTop;
					...
					function mouseMove(e) {
						...
						var diffScroll = startedScrollTop - scrollTop;
						startedScrollTop = document.getElementsByClassName('overflow-grid')[0].scrollTop;
