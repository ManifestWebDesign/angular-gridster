...
(function(root, factory) {
	...
	return angular.module('gridster', [])
		...
		.constant('gridsterConfig', {
			...
			allowOverlapping: false, // whether to allow overlapping of elements or not
			...
			function($document, $window, GridsterTouch) {
				function GridsterDraggable($el, scope, gridster, item, itemOptions) {
					...
					function drag(event) {
						...
						var hasItemsInTheWay = 0;
						if (!gridster.allowOverlapping) {
							hasItemsInTheWay = itemsInTheWay.length !== 0;
						}
